...
/**
 * Gebäude und Bereiche des Schulplans.
 *
 * Reihenfolge = Zeichenreihenfolge (spätere Einträge liegen oben). Die Einträge am Ende
 * (`uUukH`, `L1oB`, `zaub`, `Bergs-komp`, `nTal`, `haus25`) sind reine Umriss-Ebenen aus der
 * Original-Zeichnung: Sie sind auf keiner Etage anklickbar und tauchen deshalb weder in der
 * Suche noch im Detailbereich auf.
 *
 * `label` ist der Ankerpunkt der Beschriftung in viewBox-Koordinaten. Er liegt jeweils im
 * Mittelpunkt des größten in die Fläche passenden Kreises, damit die Beschriftung auch bei
 * L- und Winkelformen innerhalb des Gebäudes sitzt.
 */
export const buildings: BuildingData[] = [
  {
    ...
    shortName: "Turnhalle",
    description:
      "Die Turnhalle beherbergt die große Halle, die Umkleiden und die Toiletten. Hier wird vor allem das Fach Sport unterrichtet.",
  ...
  },
  {
    ...
    description:
      "Hier liegen die Fachräume für Gesellschaftswissenschaften mit den dazugehörigen Fluren und Nebenräumen: Geschichte, Politische Bildung und Erdkunde.",
    rooms: [
      "050",
      "051",
      "052",
  ...
  },
  {
    ...
    shortName: "Haus 2",
    description:
      "Sprachenbereich und zugehörige Unterrichtsräume. Hier werden Deutsch, Englisch, Französisch, Spanisch und selten auch Latein unterrichtet.",
    rooms: [],
    geometry: {
      kind: "path",
    ...
    floorDetails: {
      2: {
        description:
          "Auf Etage 2 (Erdgeschoss) liegen die kleine Sporthalle, das Sekretariat direkt am Durchgang zum Foyer und die Unterrichtsräume vor allem für Französisch und Spanisch.",
        rooms: ["130", "131", "132", "133", "134", "kleine Sporthalle", "Sekretariat", "Toiletten"],
      },
      3: {
        description:
          "Auf Etage 3 (1. Obergeschoss) liegen weitere Unterrichtsräume sowie die Aula. Hier werden vor allem Deutsch und Englisch unterrichtet.",
        rooms: ["230", "231", "232", "233", "234", "Aula", "Toiletten"],
      },
    },
  },
  {
    ...
    name: "Haus 3",
    shortName: "Haus 3",
    description: "Neben- und Fachbereich des Campus.",
    rooms: [],
    geometry: {
      kind: "path",
  ...
  },
  {
    ...
    floorDetails: {
      2: {
        description:
          "Auf Etage 2 liegen die naturwissenschaftlichen Fachräume für Biologie und Chemie samt Vorbereitungsraum und Sammlung.",
        rooms: ["Biologie-Fachraum", "Chemie-Fachraum", "Vorbereitungsraum", "Sammlung", "Toiletten"],
      },
      3: {
        description:
          "Etage 3 umfasst die Physikräume sowie die beiden Informatikkabinette mit dem angrenzenden Technikraum.",
  ...
  },
  {
    ...
    name: "Foyer",
    shortName: "Foyer",
    description: "Zentraler Übergangs- und Aufenthaltsbereich zwischen den Häusern.",
    rooms: [],
    geometry: {
      kind: "path",
  ...
  },
  {
    id: "Foyer2",
    name: "Unterm Foyer",
    shortName: "Unterm Foyer",
    description:
      "Zweiter Foyerbereich unterhalb des Haupt-Foyers – von Schülerinnen und Schülern „Mappenmörder“ genannt.",
    rooms: [],
    geometry: {
      kind: "path",
  ...
  // ── Reine Umriss-/Hintergrundebenen aus der Originalzeichnung – nie anklickbar ──
  {
    id: "uUukH",
    name: "Umriss Südflügel",
    shortName: "Umriss Südflügel",
    description: "Umrisslinie aus der Originalzeichnung.",
    rooms: [],
    geometry: {
      kind: "path",
  ...
  },
  {
    id: "L1oB",
    name: "Umriss Etage 1",
    shortName: "Umriss Etage 1",
    description: "Gesamtumriss der Etage 1.",
    rooms: [],
    geometry: {
      kind: "path",
  ...
  {
    id: "zaub",
    name: "Umriss Verbindungsbau",
    shortName: "Umriss Verbindungsbau",
    description: "Umrisslinie aus der Originalzeichnung.",
    rooms: [],
    geometry: {
      kind: "path",
  ...
  },
  {
    id: "Bergs-komp",
    name: "Umriss Etage 2",
    shortName: "Umriss Etage 2",
    description: "Gesamtumriss der Etage 2.",
    rooms: [],
    geometry: {
      kind: "path",
  ...
  {
    id: "nTal",
    name: "Umriss Nordflügel",
    shortName: "Umriss Nordflügel",
    description: "Umrisslinie aus der Originalzeichnung.",
    rooms: [],
    geometry: {
      kind: "path",
  ...
  },
  {
    id: "haus25",
    name: "Umriss Etage 3",
    shortName: "Umriss Etage 3",
    description: "Gesamtumriss der Etage 3.",
    rooms: [],
    geometry: {
      kind: "path",
